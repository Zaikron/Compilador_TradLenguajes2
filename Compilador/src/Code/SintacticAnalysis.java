...
public class SintacticAnalysis {
    ...
    public void analysis(Grammar g){
        ...
        /*Declaraciones: Tipos de datos */
                //Correctos
        g.group("DECLARACION", "TIPO_DATO (IDENTIFICADOR | OP_BOOL) PUNTO_COMA", true);
        g.group("DECLARACION", "TIPO_DATO (IDENTIFICADOR | OP_BOOL) ASIGNACION (NUMERO | (C_SIMPLE IDENTIFICADOR C_SIMPLE)) PUNTO_COMA", true);
                //Incorrectos
        g.group("DECLARACION", "TIPO_DATO PUNTO_COMA", true,
                2, "Error Sintactico({}): Falto crear un nombre para la variable (variable)  [Linea: #, Caracter: %]");
        g.group("DECLARACION", "TIPO_DATO ASIGNACION NUMERO PUNTO_COMA", true,
                3, "Error Sintactico({}): Falto crear un nombre para la variable (variable)  [Linea: #, Caracter: %]");
        g.group("DECLARACION", "TIPO_DATO (IDENTIFICADOR | OP_BOOL) ASIGNACION NUMERO", true,
                4, "Error Sintactico({}): Falto punto y coma (variable)  [Linea: #, Caracter: %]");
        g.group("DECLARACION", "TIPO_DATO (IDENTIFICADOR | OP_BOOL)", true,
                5, "Error Sintactico({}): Falto punto y coma (variable)  [Linea: #, Caracter: %]");
                    //Sin declaracion
        g.group("DECLARACION", "TIPO_DATO", true,
                6, "Error Sintactico({}): No esta en una declaracion correcta (variable) [Linea: #, Caracter: %]");
        ...
        g.group("DECLARACION", "INT IDENTIFICADOR PARENTESIS_A", true,
                7, "Error Sintactico({}): Error en la declaracion de la funcion principal (variable)  [Linea: #, Caracter: %]");
        ...
        g.group("BOLEANA", "SIMB_SENT IDENTIFICADOR OP_RELACIONAL (OP_BOOL | NUMERO | IDENTIFICADOR "
                + "| COMILLAS COMILLAS | COMILLAS (IDENTIFICADOR | NUMERO) COMILLAS) "
                + "OP_LOGICO SIMB_SENT IDENTIFICADOR OP_RELACIONAL (OP_BOOL | NUMERO | IDENTIFICADOR "
                + "| COMILLAS COMILLAS | COMILLAS (IDENTIFICADOR | NUMERO) COMILLAS)", true); 
        g.group("BOLEANA", "SIMB_SENT IDENTIFICADOR OP_RELACIONAL (OP_BOOL | NUMERO | IDENTIFICADOR "
                + "| COMILLAS COMILLAS | COMILLAS (IDENTIFICADOR | NUMERO) COMILLAS) "
                + "OP_LOGICO SIMB_SENT NEG IDENTIFICADOR OP_RELACIONAL (OP_BOOL | NUMERO | IDENTIFICADOR "
        ...
        g.group("BOLEANA", "SIMB_SENT IDENTIFICADOR OP_RELACIONAL (OP_BOOL | NUMERO | IDENTIFICADOR "
                + "| COMILLAS COMILLAS | COMILLAS (IDENTIFICADOR | NUMERO) COMILLAS)", true);
        g.group("BOLEANA", "SIMB_SENT  OP_RELACIONAL (LOGICA)*", true);
                //Incorrectos    
        ...
        g.group("BOLEANA", "SIMB_SENT IDENTIFICADOR (OP_BOOL | NUMERO | IDENTIFICADOR "
                + "| COMILLAS COMILLAS | COMILLAS (IDENTIFICADOR | NUMERO) COMILLAS)", true,
        ...
        g.group("BOLEANA", "OP_RELACIONAL", true,
        ...
        g.group("DECL_FOR", "SIMB_SENT OP_INCREMENTO", true,
                ...
                //Correctos
        g.group("DECLARACION", "IDENTIFICADOR ASIGNACION (IDENTIFICADOR | OP_BOOL | NUMERO) PUNTO_COMA", true);
        //->
                //Incorrectos
                    //Crear una variable con un tipo de dato que no existe
        g.group("DECLARACION", "IDENTIFICADOR (IDENTIFICADOR | OP_BOOL) PUNTO_COMA", true,
                61, "Error Sintactico({}): El tipo de dato no existe (variable)  [Linea: #, Caracter: %]");
        g.group("DECLARACION", "IDENTIFICADOR (IDENTIFICADOR | OP_BOOL)", true,
                62, "Error Sintactico({}): El tipo de dato no existe y falta punto y coma (variable)  [Linea: #, Caracter: %]");
                    //Errores en asignacion
        g.group("DECLARACION", "IDENTIFICADOR ASIGNACION (IDENTIFICADOR | OP_BOOL | NUMERO)", true,
                63, "Error Sintactico({}): Falto punto y coma (variable) [Linea: #, Caracter: %]");
        g.group("DECLARACION", "ASIGNACION (IDENTIFICADOR | OP_BOOL | NUMERO) PUNTO_COMA", true,
        ...
        g.group("DECLARACION", "IDENTIFICADOR (IDENTIFICADOR | OP_BOOL | NUMERO) PUNTO_COMA", true,
